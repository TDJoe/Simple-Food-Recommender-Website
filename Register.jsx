...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50" style={{ backgroundImage: `url('https://img.freepik.com/free-vector/vector-cartoon-illustration-various-vegetables-wooden-background_1441-519.jpg?w=1060&t=st=1726167140~exp=1726167740~hmac=d2e39d83502bf57e3df56af8c4da8a6461e787cd0d9806e5b8676e30072a2e87')`, backgroundSize: 'cover' }}>
